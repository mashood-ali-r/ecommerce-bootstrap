...
@section('title', 'Create Account - EEZEPC.com')
            ...
            <div class="row justify-content-center">
                <div class="col-11 col-sm-8 col-md-6 col-lg-4">
                    ...
                    <div class="auth-card"
                        ...
                        <!-- Form Body -->
                        <div class="p-4">
                            <h4 class="mb-1 fw-bold" style="color: #131921;">Create Account</h4>
                            <p class="mb-4" style="font-size: 13px; color: #666;">Join EEZEPC and start shopping!</p>
                            ...
                            <form method="POST" action="{{ route('register.post') }}">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label fw-semibold"
                                        style="font-size: 13px; color: #131921;">Your Name</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="d-flex align-items-center mt-1" style="font-size: 11px; color: #666;">
                                        <i class="fa-solid fa-info-circle me-1"></i> Passwords must be at least 8
                                        characters.
                                    </small>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="password_confirmation" class="form-label fw-semibold"
                                        style="font-size: 13px; color: #131921;">Re-enter Password</label>
                                    <div class="input-group">
                                        <span class="input-group-text"
                                            style="background: #f7f7f7; border: 1px solid #d5d9d9; border-right: none; border-radius: 8px 0 0 8px;">
                                            <i class="fa-solid fa-lock" style="color: #666;"></i>
                                ...
                                <div class="mb-4">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label ms-1" for="terms"
                                            ...
                                            I agree to the <a href="#" style="color: #007185;">Terms of Use</a> and <a
                        ...
                        <div class="px-4 py-2">
                            <div class="d-flex align-items-center">
                                ...
                                <span class="px-3" style="font-size: 12px; color: #767676;">Already have an account?</span>
                                <hr class="flex-grow-1" style="border-color: #ddd;">
                            </div>
                        </div>
