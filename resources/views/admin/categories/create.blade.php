...
@section('breadcrumb')
    <a href="{{ route('admin.categories.index') }}">Categories</a> / New Category
@endsection
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="slug" class="form-input @error('slug') is-invalid @enderror"
                                    value="{{ old('slug') }}" placeholder="category-url-slug">
                                @error('slug')
                                    <div class="field-error">{{ $message }}</div>
                                @enderror
                            </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="form-card tips-card">
                    ...
                    <div class="tips-body">
                        <div class="tip-item">
                            ...
                            <span>Use clear, descriptive names for categories</span>
                        </div>
                        <div class="tip-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Parent categories help create navigation hierarchy</span>
                        </div>
                        <div class="tip-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Slugs appear in URLs and should be lowercase</span>
                        </div>
                        <div class="tip-item">
                            <i class="fas fa-check-circle"></i>
                            <span>Use sort order to control display position</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-card action-card">
                    ...
                    <div class="action-hint">
                        ...
                        After creating, add products to this category
                    </div>
                </div>
            </div>
        </div>
